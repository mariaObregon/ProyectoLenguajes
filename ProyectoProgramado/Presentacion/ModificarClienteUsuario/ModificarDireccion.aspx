<%@ Page Title="" Language="C#" MasterPageFile="~/ModificarClienteUsuario/MasterModificar.master" AutoEventWireup="true" CodeBehind="ModificarDireccion.aspx.cs" Inherits="Presentacion.ModificarClienteUsuario.ModificarDireccion" %>
        ...
        <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
            ...
            <tr>
                ...
                <td class="auto-style48" style="background-color: #C0C0C0; border-color: #C0C0C0">
                    <asp:Button ID="BtnModificarDireccion" runat="server" Height="36px" Text="Modificar Dirección" Width="300px" OnClick="BtnModificarDireccion_Click" />
                </td>
            </tr>
        </table>
    </asp:Panel>

...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Panel ID="PanelContraseña" runat="server" Height="236px" Width="100%">
        <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
            ...
            <tr>
                ...
                <td class="auto-style72" style="background-color: #C0C0C0; border-color: #C0C0C0; width: 272px;">&nbsp;</td>
                <td class="auto-style73" style="background-color: #C0C0C0; border-color: #C0C0C0">&nbsp;</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="auto-style48" style="background-color: #C0C0C0; border-color: #C0C0C0">&nbsp;</td>
            </tr>
            <tr>
    ...
    <asp:Panel ID="PanelDatosPersonales" runat="server" Height="252px" Width="100%">
        <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
            <tr>
                <td class="auto-style20" colspan="4" style="background-color: #333333; color: #FFFFFF; text-align: center;">
            ...
            <tr>
                <td class="auto-style71" style="background-color: #C0C0C0; border-color: #C0C0C0; width: 214px;">&nbsp;</td>
                <td class="auto-style70" style="background-color: #C0C0C0; border-color: #C0C0C0; width: 343px;">&nbsp;</td>
                <td class="auto-style72" style="background-color: #C0C0C0; border-color: #C0C0C0; width: 272px;">&nbsp;</td>
                <td class="auto-style73" style="background-color: #C0C0C0; border-color: #C0C0C0">&nbsp;</td>
            </tr>
            <tr>
    ...
    <asp:Panel ID="PanelModificarContacto" runat="server" Height="233px" Width="100%">
        <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
            <tr>
                <td class="auto-style20" colspan="4" style="background-color: #333333; color: #FFFFFF; text-align: center;">
    ...
    <asp:Panel ID="PanelModificarDireccion" runat="server" Height="359px">
        <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
            <tr>
                <td class="auto-style20" colspan="4" style="background-color: #333333; color: #FFFFFF; text-align: center;">

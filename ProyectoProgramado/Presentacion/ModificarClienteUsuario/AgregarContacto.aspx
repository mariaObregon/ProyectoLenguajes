<%@ Page Title="" Language="C#" MasterPageFile="~/ModificarClienteUsuario/MasterModificar.master" AutoEventWireup="true" CodeBehind="AgregarContacto.aspx.cs" Inherits="Presentacion.ModificarClienteUsuario.AgregarContacto" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentModificar" runat="server">
    <asp:Panel ID="PanelAgregarContacto" runat="server" Height="242px" Width="100%">
                    <table class="auto-style19" style="border-color: #FFFFFF; border-style: none; font-family: Verdana, Geneva, Tahoma, sans-serif; background-color: #C0C0C0; width: 100%;">
                        ...
                        <tr>
                            ...
                            <td class="auto-style48" style="background-color: #C0C0C0; border-color: #C0C0C0">
                                <asp:Button ID="BtnAgregarContacto" runat="server" Height="36px" Text="Agregar Contacto" Width="300px" OnClick="BtnAgregarContacto_Click" />
                            </td>
                        </tr>
                    </table>
                </asp:Panel>
